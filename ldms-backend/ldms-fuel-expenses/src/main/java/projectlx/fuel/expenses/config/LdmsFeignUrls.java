...
public final class LdmsFeignUrls {
    ...
    public static String resolveTripTrackingServiceBaseUrl(org.springframework.core.env.Environment env) {
        return resolveServiceUrl(env, "CLIENTS_TRIP_TRACKING_SERVICE_URL", "clients.base-url.tripTrackingService");
    }
