...
public enum I18Code {
    ...
    MESSAGE_BOT_ASSISTANT_MODE_UPDATED("message.bot.assistant.mode.updated"),
    MESSAGE_BOT_ASSISTANT_MODE_INVALID("message.bot.assistant.mode.invalid.request"),
    MESSAGE_BOT_PRICING_RETRIEVED("message.bot.pricing.retrieved"),
