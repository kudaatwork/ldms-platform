...
@CrossOrigin
@RestController
@RequestMapping("/ldms-user-management/v1/backoffice/user")
@Tag(name = "User Backoffice Resource", description = "Operations related to managing users")
@RequiredArgsConstructor
public class UserBackofficeResource {

    private final UserServiceProcessor userServiceProcessor;
    private static final Logger logger = LoggerFactory.getLogger(UserBackofficeResource.class);
    ...
    public UserResponse createUser(@Valid @ModelAttribute final CreateUserRequest createUserRequest,
        ...
        return userServiceProcessor.create(createUserRequest, locale, "BACKOFFICE");
    }
    ...
    public UserResponse delete(@PathVariable("id") final Long id,
                                   ...
                                   @RequestHeader(value = Constants.LOCALE_LANGUAGE,
                                           defaultValue = Constants.DEFAULT_LOCALE) final Locale locale)
    {
        return userServiceProcessor.delete(id, locale, "BACKOFFICE");
    }
    ...
    public UserResponse findAllAsAList(@Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                           @RequestHeader(value = Constants.LOCALE_LANGUAGE,
                                                   defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return userServiceProcessor.findAllAsList(locale, "BACKOFFICE");
    }
    ...
    public UserResponse findByMultipleFilters(@Valid @RequestBody UsersMultipleFiltersRequest usersMultipleFiltersRequest,
                                                 ...
                                                 @RequestHeader(value = Constants.LOCALE_LANGUAGE,
                                                         defaultValue = Constants.DEFAULT_LOCALE) final Locale locale)
    {
        return userServiceProcessor.findByMultipleFilters(usersMultipleFiltersRequest, "BACKOFFICE", locale);
    }
    ...
    public UserResponse findByOrganizationId(@PathVariable("organizationId") final Long organizationId,
        ...
        UserResponse response = userServiceProcessor.findByOrganizationId(organizationId, locale, "BACKOFFICE");
    ...
    public UserResponse findByBranchId(@PathVariable("branchId") final Long branchId,
        ...
        UserResponse response = userServiceProcessor.findByBranchId(branchId, locale, "BACKOFFICE");
        ...
        try {
            ...
            switch (format.toLowerCase()) {
                ...
                case "csv":
                    ...
                    data = userServiceProcessor.exportToCsv(filters, "BACKOFFICE", locale);
                ...
                case "xlsx":
                    ...
                    data = userServiceProcessor.exportToExcel(filters, "BACKOFFICE", locale);
                ...
                case "pdf":
                    ...
                    data = userServiceProcessor.exportToPdf(filters, "BACKOFFICE", locale);
    ...
    public UserResponse verifyEmail(@RequestParam String token, @RequestParam String email,
                                      ...
                                      @RequestHeader(value = Constants.LOCALE_LANGUAGE,
                                              defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return userServiceProcessor.verifyEmail(email, token, locale, "BACKOFFICE");
    }
