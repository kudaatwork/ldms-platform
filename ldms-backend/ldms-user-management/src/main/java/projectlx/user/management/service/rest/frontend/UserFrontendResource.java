...
@CrossOrigin
@RestController
@RequestMapping("/ldms-user-management/v1/frontend/user")
...
public class UserFrontendResource {
    ...
    @PreAuthorize("hasRole(T(projectlx.user.management.utils.security.UserRoles).CREATE_USER.toString())")
    @PostMapping("/create")
    ...
    @PreAuthorize("hasRole(T(projectlx.user.management.utils.security.UserRoles).VIEW_USER_BY_USERNAME.toString())")
    ...
    @PreAuthorize("hasRole(T(projectlx.user.management.utils.security.UserRoles).VIEW_USER_BY_PHONE_NUMBER_OR_EMAIL.toString())")
    ...
    @PreAuthorize("hasRole(T(projectlx.user.management.utils.security.UserRoles).DELETE_USER.toString())")
    ...
    @PreAuthorize("hasRole(T(projectlx.user.management.utils.security.UserRoles).VIEW_ALL_USERS_AS_A_LIST.toString())")
    ...
    @PreAuthorize("hasRole(T(projectlx.user.management.utils.security.UserRoles).VIEW_ALL_USERS_BY_MULTIPLE_FILTERS.toString())")
    ...
    @PreAuthorize("hasRole(T(projectlx.user.management.utils.security.UserRoles).VIEW_USERS_BY_BRANCH.toString())")
    ...
    @PreAuthorize("hasRole(T(projectlx.user.management.utils.security.UserRoles).VERIFY_USER_EMAIL.toString())")
    ...
    @PreAuthorize("hasRole(T(projectlx.user.management.utils.security.UserRoles).FORGOT_PASSWORD.toString())")
    ...
    @PreAuthorize("hasRole(T(projectlx.user.management.utils.security.UserRoles).VALIDATE_RESET_TOKEN.toString())")
    ...
    @PreAuthorize("hasRole(T(projectlx.user.management.utils.security.UserRoles).RESEND_VERIFICATION_LINK.toString())")
