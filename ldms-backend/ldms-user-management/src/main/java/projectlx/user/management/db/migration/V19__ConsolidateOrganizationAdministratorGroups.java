...
/**
 * Uses the single platform-wide {@code Administrator} group for all workspace admins.
 * Reassigns users off per-organisation duplicate groups and soft-deletes those groups.
 */
public class V19__ConsolidateOrganizationAdministratorGroups extends BaseJavaMigration {
