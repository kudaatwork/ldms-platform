...
@CrossOrigin
@RestController
@RequestMapping("/ldms-user-management/v1/backoffice/user-password")
@Tag(name = "User Password Backoffice Resource", description = "Operations related to managing user passwords")
@RequiredArgsConstructor
public class UserPasswordBackofficeResource {
    ...
    public UserPasswordResponse update(@Valid @RequestBody final ChangeUserPasswordRequest changeUserPasswordRequest,
        ...
        return userPasswordServiceProcessor.update(changeUserPasswordRequest, "BACKOFFICE", locale);
    }
    ...
    public UserPasswordResponse resetPassword(@Valid @RequestBody ResetPasswordRequest resetPasswordRequest,
                                              ...
                                              @RequestHeader(value = Constants.LOCALE_LANGUAGE,
                                                      defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return userPasswordServiceProcessor.resetPassword(resetPasswordRequest, locale, "BACKOFFICE");
    }
}
