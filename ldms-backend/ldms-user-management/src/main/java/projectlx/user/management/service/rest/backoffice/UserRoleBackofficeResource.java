...
@CrossOrigin
@RestController
@RequestMapping("/ldms-user-management/v1/backoffice/user-role")
@Tag(name = "User Role Backoffice Resource", description = "Operations related to managing user roles.")
...
public class UserRoleBackofficeResource {
    ...
    public UserRoleResponse create(@Valid @RequestBody final CreateUserRoleRequest createUserAddressRequest,
        ...
        return userRoleServiceProcessor.create(createUserAddressRequest, locale, "BACKOFFICE");
    }
    ...
    public UserRoleResponse update(@Valid @RequestBody final EditUserRoleRequest editUserRoleRequest,
                                    ...
                                    @RequestHeader(value = Constants.LOCALE_LANGUAGE,
                                            defaultValue = Constants.DEFAULT_LOCALE) final Locale locale){
        return userRoleServiceProcessor.update(editUserRoleRequest, "BACKOFFICE", locale);
    }
    ...
    public UserRoleResponse findById(@PathVariable("id") final Long id,
                                      ...
                                      @RequestHeader(value = Constants.LOCALE_LANGUAGE,
                                              defaultValue = Constants.DEFAULT_LOCALE) final Locale locale)
    {
        return userRoleServiceProcessor.findById(id, locale, "BACKOFFICE");
    }
    ...
    public UserRoleResponse delete(@PathVariable("id") final Long id,
                                    ...
                                    @RequestHeader(value = Constants.LOCALE_LANGUAGE,
                                            defaultValue = Constants.DEFAULT_LOCALE) final Locale locale)
    {
        return userRoleServiceProcessor.delete(id, locale, "BACKOFFICE");
    }
    ...
    public UserRoleResponse findAllAsAList(@Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                            @RequestHeader(value = Constants.LOCALE_LANGUAGE,
                                                    defaultValue = Constants.DEFAULT_LOCALE) final Locale locale)
    {
        return userRoleServiceProcessor.findAllAsList("BACKOFFICE", locale);
    }
    ...
    public ResponseEntity<byte[]> exportUserRoles(@RequestBody UserRoleMultipleFiltersRequest filters,
        ...
        try {
            ...
            switch (format.toLowerCase()) {
                case "csv":
                    data = userRoleServiceProcessor.exportToCsv(filters, "BACKOFFICE", locale);
                ...
                case "excel":
                case "xlsx":
                    data = userRoleServiceProcessor.exportToExcel(filters, "BACKOFFICE", locale);
                    contentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                    filename = "user-roles.xlsx";
                    break;

                case "pdf":
                    data = userRoleServiceProcessor.exportToPdf(filters, "BACKOFFICE", locale);
