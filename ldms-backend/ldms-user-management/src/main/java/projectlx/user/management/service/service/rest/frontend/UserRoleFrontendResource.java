...
@CrossOrigin
@RestController
@RequestMapping("/api/v1/frontend/user-role")
...
public class UserRoleFrontendResource {
    ...
    @PreAuthorize("hasRole(T(projectlx.user.management.service.utils.security.UserRoleRoles).CREATE_USER_ROLE.toString())")
    @PostMapping("/create")
    ...
    @PreAuthorize("hasRole(T(projectlx.user.management.service.utils.security.UserRoleRoles).UPDATE_USER_ROLE.toString())")
    @PutMapping("/update")
    ...
    @PreAuthorize("hasRole(T(projectlx.user.management.service.utils.security.UserRoleRoles).VIEW_USER_ROLE_BY_ID.toString())")
    ...
    @PreAuthorize("hasRole(T(projectlx.user.management.service.utils.security.UserRoleRoles).DELETE_USER_ROLE.toString())")
    ...
    @PreAuthorize("hasRole(T(projectlx.user.management.service.utils.security.UserRoleRoles).VIEW_ALL_USER_ROLES_AS_A_LIST.toString())")
    ...
    @PreAuthorize("hasRole(T(projectlx.user.management.service.utils.security.UserRoleRoles).VIEW_ALL_USER_ROLES_BY_MULTIPLE_FILTERS.toString())")
    ...
    @PreAuthorize("hasRole(T(projectlx.user.management.service.utils.security.UserRoleRoles).IMPORT_USER_ROLES.toString())")
