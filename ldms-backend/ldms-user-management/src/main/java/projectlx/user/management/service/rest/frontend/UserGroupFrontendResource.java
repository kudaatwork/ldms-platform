...
@CrossOrigin
@RestController
@RequestMapping("/ldms-user-management/v1/frontend/user-group")
...
public class UserGroupFrontendResource {
    ...
    @PreAuthorize("hasRole(T(projectlx.user.management.utils.security.UserGroupRoles).EXPORT_USER_GROUPS.toString())")
