...
@CrossOrigin
@RestController
@RequestMapping("/api/v1/frontend/user-address")
...
public class UserAddressFrontendResource {
    ...
    @PreAuthorize("hasRole(T(projectlx.user.management.service.utils.security.UserAddressRoles)." +
    ...
    @PreAuthorize("hasRole(T(projectlx.user.management.service.utils.security.UserAddressRoles).EXPORT_USER_ADDRESSES.toString())")
