...
@CrossOrigin
@RestController
@RequestMapping("/ldms-user-management/v1/backoffice/user-preferences")
@Tag(name = "User Preferences Backoffice Resource", description = "Operations related to managing user preferences")
@RequiredArgsConstructor
public class UserPreferencesBackofficeResource {
    ...
    public UserPreferencesResponse create(@Valid @RequestBody final CreateUserPreferencesRequest createUserPreferencesRequest,
        ...
        return userPreferencesServiceProcessor.create(createUserPreferencesRequest, locale, "BACKOFFICE");
    }
    ...
    public UserPreferencesResponse update(@Valid @RequestBody final EditUserPreferencesRequest editUserPreferencesRequest,
                                    ...
                                    @RequestHeader(value = Constants.LOCALE_LANGUAGE,
                                            defaultValue = Constants.DEFAULT_LOCALE) final Locale locale){
        return userPreferencesServiceProcessor.update(editUserPreferencesRequest, "BACKOFFICE", locale);
    }
    ...
    public UserPreferencesResponse findById(@PathVariable("id") final Long id,
                                      ...
                                      @RequestHeader(value = Constants.LOCALE_LANGUAGE,
                                              defaultValue = Constants.DEFAULT_LOCALE) final Locale locale)
    {
        return userPreferencesServiceProcessor.findById(id, locale, "BACKOFFICE");
    }
    ...
    public UserPreferencesResponse delete(@PathVariable("id") final Long id,
                                    ...
                                    @RequestHeader(value = Constants.LOCALE_LANGUAGE,
                                            defaultValue = Constants.DEFAULT_LOCALE) final Locale locale)
    {
        return userPreferencesServiceProcessor.delete(id, locale, "BACKOFFICE");
    }
    ...
    public UserPreferencesResponse findAllAsAList(@Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                            @RequestHeader(value = Constants.LOCALE_LANGUAGE,
                                                    defaultValue = Constants.DEFAULT_LOCALE) final Locale locale)
    {
        return userPreferencesServiceProcessor.findAllAsList("BACKOFFICE", locale);
    }
    ...
    public UserPreferencesResponse findByMultipleFilters(@Valid @RequestBody UserPreferencesMultipleFiltersRequest
                                                   ...
                                                   @RequestHeader(value = Constants.LOCALE_LANGUAGE,
                                                           defaultValue = Constants.DEFAULT_LOCALE) final Locale locale)
    {
        return userPreferencesServiceProcessor.findByMultipleFilters(userPreferencesMultipleFiltersRequest, "BACKOFFICE", locale);
    }
}
