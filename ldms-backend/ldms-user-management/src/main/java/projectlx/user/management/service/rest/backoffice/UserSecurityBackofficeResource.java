...
@CrossOrigin
@RestController
@RequestMapping("/ldms-user-management/v1/backoffice/user-security")
@Tag(name = "User Security Backoffice Resource", description = "Operations related to managing user Securities.")
@RequiredArgsConstructor
public class UserSecurityBackofficeResource {
    ...
    public UserSecurityResponse create(@Valid @RequestBody final CreateUserSecurityRequest createUserAddressRequest,
        ...
        return userSecurityServiceProcessor.create(createUserAddressRequest, locale, "BACKOFFICE");
    }
    ...
    public UserSecurityResponse update(@Valid @RequestBody final EditUserSecurityRequest editUserSecurityRequest,
                                    ...
                                    @RequestHeader(value = Constants.LOCALE_LANGUAGE,
                                            defaultValue = Constants.DEFAULT_LOCALE) final Locale locale){
        return userSecurityServiceProcessor.update(editUserSecurityRequest, "BACKOFFICE", locale);
    }
    ...
    public UserSecurityResponse findById(@PathVariable("id") final Long id,
                                      ...
                                      @RequestHeader(value = Constants.LOCALE_LANGUAGE,
                                              defaultValue = Constants.DEFAULT_LOCALE) final Locale locale)
    {
        return userSecurityServiceProcessor.findById(id, locale, "BACKOFFICE");
    }
    ...
    public UserSecurityResponse delete(@PathVariable("id") final Long id,
                                    ...
                                    @RequestHeader(value = Constants.LOCALE_LANGUAGE,
                                            defaultValue = Constants.DEFAULT_LOCALE) final Locale locale)
    {
        return userSecurityServiceProcessor.delete(id, locale, "BACKOFFICE");
    }
    ...
    public UserSecurityResponse findAllAsAList(@Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                            @RequestHeader(value = Constants.LOCALE_LANGUAGE,
                                                    defaultValue = Constants.DEFAULT_LOCALE) final Locale locale)
    {
        return userSecurityServiceProcessor.findAllAsList("BACKOFFICE", locale);
    }
