 ...
 * Local dev calls the API gateway (default port 8091), not individual microservice ports or the Angular dev server.
 */
public final class LdmsFeignUrls {
    ...
    /**
     * API gateway origin (e.g. {@code http://127.0.0.1:8091}). Never the Angular dev server ({@code :4200}).
     */
