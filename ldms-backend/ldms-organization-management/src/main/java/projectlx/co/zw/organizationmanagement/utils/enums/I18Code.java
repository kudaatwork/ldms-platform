...
public enum I18Code {
    ...
    ORG_FORBIDDEN_SUPPLIERS("org.forbidden.suppliers"),
    ...
    ORG_TRANSPORTER_OFFER_SENT("org.transporter.offer.sent"),
    ORG_TRANSPORTER_OFFER_ACCEPTED("org.transporter.offer.accepted"),
    ORG_TRANSPORTER_OFFER_DECLINED("org.transporter.offer.declined"),
    ORG_TRANSPORTER_OFFER_CANCELLED("org.transporter.offer.cancelled"),
    ORG_TRANSPORTER_OFFER_NOT_FOUND("org.transporter.offer.notFound"),
