...
public interface OrganizationService {
    ...
    OrganizationResponse getByIdForFrontend(Long id, String username, Locale locale);
    ...
    /** Active industries for organisation forms (platform-wide catalogue from admin). */
