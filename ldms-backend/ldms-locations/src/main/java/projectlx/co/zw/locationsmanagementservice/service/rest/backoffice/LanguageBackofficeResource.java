...
@RestController
@RequestMapping("/ldms-locations/v1/backoffice/language")
@Tag(name = "Language Backoffice Resource", description = "Operations related to managing languages (backoffice)")
@RequiredArgsConstructor
public class LanguageBackofficeResource {

    private final LanguageServiceProcessor languageServiceProcessor;
    private static final Logger logger = LoggerFactory.getLogger(LanguageBackofficeResource.class);
    ...
    public LanguageResponse create(@Valid @RequestBody final CreateLanguageRequest createLanguageRequest,
        ...
        return languageServiceProcessor.create(createLanguageRequest, locale, "BACKOFFICE");
    }
    ...
    public LanguageResponse update(@Valid @RequestBody final EditLanguageRequest editLanguageRequest,
                                 @Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                 @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return languageServiceProcessor.update(editLanguageRequest, locale, "BACKOFFICE");
    }
    ...
    public LanguageResponse findById(@PathVariable("id") final Long id,
                                   @Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                   @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return languageServiceProcessor.findById(id, locale, "BACKOFFICE");
    }
    ...
    public LanguageResponse delete(@PathVariable("id") final Long id,
                                 @Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                 @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return languageServiceProcessor.delete(id, locale, "BACKOFFICE");
    }
    ...
    public LanguageResponse findAllAsAList(@Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                         @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return languageServiceProcessor.findAll(locale, "BACKOFFICE");
    }
    ...
    public LanguageResponse findByMultipleFilters(@Valid @RequestBody LanguageMultipleFiltersRequest languageMultipleFiltersRequest,
                                               @Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                               @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return languageServiceProcessor.findByMultipleFilters(languageMultipleFiltersRequest, "BACKOFFICE", locale);
    }
    ...
    public ResponseEntity<byte[]> exportLanguages(@RequestBody LanguageMultipleFiltersRequest filters,
        ...
        try {
            ...
            LanguageResponse response = languageServiceProcessor.findByMultipleFilters(filters, "BACKOFFICE", locale);
            List<LanguageDto> dtoList = response.getLanguageDtoPage() != null
                    ? response.getLanguageDtoPage().getContent()
                    : new ArrayList<>();
