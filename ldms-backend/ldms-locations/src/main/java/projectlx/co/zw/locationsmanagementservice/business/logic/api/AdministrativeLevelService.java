...
public interface AdministrativeLevelService {
    ...
    AdministrativeLevelResponse findAllAsList(Locale locale, String username);
    AdministrativeLevelResponse update(EditAdministrativeLevelRequest request, String username, Locale locale);
    ...
    byte[] exportToCsv(List<AdministrativeLevelDto> items);
    byte[] exportToExcel(List<AdministrativeLevelDto> items) throws IOException;
    byte[] exportToPdf(List<AdministrativeLevelDto> items) throws DocumentException;
    ImportSummary importAdministrativeLevelFromCsv(InputStream csvInputStream) throws IOException;
}