...
@RestController
@RequestMapping("/ldms-locations/v1/backoffice/country")
@Tag(name = "Country Backoffice Resource", description = "Operations related to managing countries (backoffice)")
@RequiredArgsConstructor
public class CountryBackofficeResource {

    private final CountryServiceProcessor countryServiceProcessor;
    private static final Logger logger = LoggerFactory.getLogger(CountryBackofficeResource.class);
    ...
    public ResponseEntity<CountryResponse> create(@Valid @RequestBody final CreateCountryRequest createCountryRequest,
        ...
        return ResponseEntity.ok(countryServiceProcessor.create(createCountryRequest, locale, "BACKOFFICE"));
    }
    ...
    public ResponseEntity<CountryResponse> update(@Valid @RequestBody final EditCountryRequest editCountryRequest,
                                 ...
                                 final Locale locale) {
        return ResponseEntity.ok(countryServiceProcessor.update(editCountryRequest, locale, "BACKOFFICE"));
    }
    ...
    public ResponseEntity<CountryResponse> findById(@PathVariable("id") final Long id,
                                   @Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                   @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return ResponseEntity.ok(countryServiceProcessor.findById(id, locale, "BACKOFFICE"));
    }
    ...
    public ResponseEntity<CountryResponse> delete(@PathVariable("id") final Long id,
                                 @Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                 @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return ResponseEntity.ok(countryServiceProcessor.delete(id, locale, "BACKOFFICE"));
    }
    ...
    public ResponseEntity<CountryResponse> findAllAsAList(@Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                         @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return ResponseEntity.ok(countryServiceProcessor.findAll(locale, "BACKOFFICE"));
    }
    ...
    public ResponseEntity<CountryResponse> findByMultipleFilters(@Valid @RequestBody CountryMultipleFiltersRequest countryMultipleFiltersRequest,
                                               @Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                               @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return ResponseEntity.ok(countryServiceProcessor.findByMultipleFilters(countryMultipleFiltersRequest, "BACKOFFICE", locale));
    }
    ...
    public ResponseEntity<byte[]> exportCountries(@RequestBody CountryMultipleFiltersRequest filters,
        ...
        try {
            ...
            CountryResponse response = countryServiceProcessor.findByMultipleFilters(filters, "BACKOFFICE", locale);
