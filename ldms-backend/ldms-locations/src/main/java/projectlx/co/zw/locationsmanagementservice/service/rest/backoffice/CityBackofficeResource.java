...
@RestController
@RequestMapping("/ldms-locations/v1/backoffice/city")
@Tag(name = "City Backoffice Resource", description = "Operations related to managing cities (backoffice)")
@RequiredArgsConstructor
public class CityBackofficeResource {

    private final CityServiceProcessor cityServiceProcessor;
    private static final Logger logger = LoggerFactory.getLogger(CityBackofficeResource.class);
    ...
    public ResponseEntity<CityResponse> create(@Valid @RequestBody final CreateCityRequest createCityRequest,
        ...
        return ResponseEntity.ok(cityServiceProcessor.create(createCityRequest, locale, "BACKOFFICE"));
    }
    ...
    public ResponseEntity<CityResponse> update(@Valid @RequestBody final EditCityRequest editCityRequest,
                                 ...
                                 final Locale locale) {
        return ResponseEntity.ok(cityServiceProcessor.update(editCityRequest, locale, "BACKOFFICE"));
    }
    ...
    public ResponseEntity<CityResponse> findById(@PathVariable("id") final Long id,
                                   @Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                   @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return ResponseEntity.ok(cityServiceProcessor.findById(id, locale, "BACKOFFICE"));
    }
    ...
    public ResponseEntity<CityResponse> delete(@PathVariable("id") final Long id,
                                 @Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                 @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return ResponseEntity.ok(cityServiceProcessor.delete(id, locale, "BACKOFFICE"));
    }
    ...
    public ResponseEntity<CityResponse> findAllAsAList(@Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                         @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return ResponseEntity.ok(cityServiceProcessor.findAll(locale, "BACKOFFICE"));
    }
    ...
    public ResponseEntity<CityResponse> findByMultipleFilters(@Valid @RequestBody CityMultipleFiltersRequest cityMultipleFiltersRequest,
                                               @Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                               @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return ResponseEntity.ok(cityServiceProcessor.findByMultipleFilters(cityMultipleFiltersRequest, "BACKOFFICE", locale));
    }
    ...
    public ResponseEntity<byte[]> exportCities(@RequestBody CityMultipleFiltersRequest filters,
        ...
        try {
            ...
            CityResponse response = cityServiceProcessor.findByMultipleFilters(filters, "BACKOFFICE", locale);
