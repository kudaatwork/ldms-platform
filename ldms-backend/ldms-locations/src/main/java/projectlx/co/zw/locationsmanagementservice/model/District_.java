...
public class District_ {
    ...
    public static volatile SingularAttribute<District, AdministrativeLevel> administrativeLevel;
    public static volatile SingularAttribute<District, EntityStatus> entityStatus;
}