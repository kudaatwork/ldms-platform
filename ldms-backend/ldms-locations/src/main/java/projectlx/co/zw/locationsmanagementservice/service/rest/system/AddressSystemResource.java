...
@CrossOrigin
@RestController
@RequestMapping("/ldms-locations/v1/system/address")
@Tag(name = "Address System Resource", description = "Operations related to managing addresses (system)")
@RequiredArgsConstructor
public class AddressSystemResource {

    private final AddressServiceProcessor addressServiceProcessor;
    private static final Logger logger = LoggerFactory.getLogger(AddressSystemResource.class);
    ...
    public ResponseEntity<AddressResponse> create(@Valid @RequestBody final CreateAddressRequest createAddressRequest,
        ...
        return ResponseEntity.ok(addressServiceProcessor.create(createAddressRequest, locale, "SYSTEM"));
    }
    ...
    public ResponseEntity<AddressResponse> update(@Valid @RequestBody final EditAddressRequest editAddressRequest,
                                 ...
                                 final Locale locale) {
        return ResponseEntity.ok(addressServiceProcessor.update(editAddressRequest, locale, "SYSTEM"));
    }
    ...
    public ResponseEntity<AddressResponse> findById(@PathVariable("id") final Long id,
                                   @Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                   @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return ResponseEntity.ok(addressServiceProcessor.findById(id, locale, "SYSTEM"));
    }
    ...
    public ResponseEntity<AddressResponse> delete(@PathVariable("id") final Long id,
                                 @Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                 @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return ResponseEntity.ok(addressServiceProcessor.delete(id, locale, "SYSTEM"));
    }
    ...
    public ResponseEntity<AddressResponse> findAllAsAList(@Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                         @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return ResponseEntity.ok(addressServiceProcessor.findAllAsAList(locale, "SYSTEM"));
    }
    ...
    public ResponseEntity<AddressResponse> findByMultipleFilters(@Valid @RequestBody AddressMultipleFiltersRequest addressMultipleFiltersRequest,
                                               @Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                               @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return ResponseEntity.ok(addressServiceProcessor.findByMultipleFilters(addressMultipleFiltersRequest, "SYSTEM", locale));
    }
    ...
    public ResponseEntity<byte[]> exportAddresses(@RequestBody AddressMultipleFiltersRequest filters,
        ...
        try {
            ...
            AddressResponse response = addressServiceProcessor.findByMultipleFilters(filters, "SYSTEM", locale);
