...
@RestController
@RequestMapping("/ldms-locations/v1/backoffice/suburb")
@Tag(name = "Suburb Backoffice Resource", description = "Operations related to managing suburbs (backoffice)")
@RequiredArgsConstructor
public class SuburbBackofficeResource {

    private final SuburbServiceProcessor suburbServiceProcessor;
    private static final Logger logger = LoggerFactory.getLogger(SuburbBackofficeResource.class);
    ...
    public ResponseEntity<SuburbResponse> create(@Valid @RequestBody final CreateSuburbRequest createSuburbRequest,
        ...
        return ResponseEntity.ok(suburbServiceProcessor.create(createSuburbRequest, locale, "BACKOFFICE"));
    }
    ...
    public ResponseEntity<SuburbResponse> update(@Valid @RequestBody final EditSuburbRequest editSuburbRequest,
                                 ...
                                 final Locale locale) {
        return ResponseEntity.ok(suburbServiceProcessor.update(editSuburbRequest, locale, "BACKOFFICE"));
    }
    ...
    public ResponseEntity<SuburbResponse> findById(@PathVariable("id") final Long id,
                                   @Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                   @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return ResponseEntity.ok(suburbServiceProcessor.findById(id, locale, "BACKOFFICE"));
    }
    ...
    public ResponseEntity<SuburbResponse> delete(@PathVariable("id") final Long id,
                                 @Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                 @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return ResponseEntity.ok(suburbServiceProcessor.delete(id, locale, "BACKOFFICE"));
    }
    ...
    public ResponseEntity<SuburbResponse> findAllAsAList(@Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                         @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return ResponseEntity.ok(suburbServiceProcessor.findAll(locale, "BACKOFFICE"));
    }
    ...
    public ResponseEntity<SuburbResponse> findByMultipleFilters(@Valid @RequestBody SuburbMultipleFiltersRequest suburbMultipleFiltersRequest,
                                               @Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                               @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return ResponseEntity.ok(suburbServiceProcessor.findByMultipleFilters(suburbMultipleFiltersRequest, "BACKOFFICE", locale));
    }
    ...
    public ResponseEntity<byte[]> exportSuburbs(@RequestBody SuburbMultipleFiltersRequest filters,
        ...
        try {
            ...
            SuburbResponse response = suburbServiceProcessor.findByMultipleFilters(filters, "BACKOFFICE", locale);
