...
@RestController
@RequestMapping("/ldms-locations/v1/backoffice/district")
@Tag(name = "District Backoffice Resource", description = "Operations related to managing districts (backoffice)")
@RequiredArgsConstructor
public class DistrictBackofficeResource {

    private final DistrictServiceProcessor districtServiceProcessor;
    private static final Logger logger = LoggerFactory.getLogger(DistrictBackofficeResource.class);
    ...
    public ResponseEntity<DistrictResponse> create(@Valid @RequestBody final CreateDistrictRequest createDistrictRequest,
        ...
        return ResponseEntity.ok(districtServiceProcessor.create(createDistrictRequest, locale, "BACKOFFICE"));
    }
    ...
    public ResponseEntity<DistrictResponse> update(@Valid @RequestBody final EditDistrictRequest editDistrictRequest,
                                 ...
                                 final Locale locale) {
        return ResponseEntity.ok(districtServiceProcessor.update(editDistrictRequest, locale, "BACKOFFICE"));
    }
    ...
    public ResponseEntity<DistrictResponse> findById(@PathVariable("id") final Long id,
                                   @Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                   @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return ResponseEntity.ok(districtServiceProcessor.findById(id, locale, "BACKOFFICE"));
    }
    ...
    public ResponseEntity<DistrictResponse> delete(@PathVariable("id") final Long id,
                                 @Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                 @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return ResponseEntity.ok(districtServiceProcessor.delete(id, locale, "BACKOFFICE"));
    }
    ...
    public ResponseEntity<DistrictResponse> findAllAsAList(@Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                         @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return ResponseEntity.ok(districtServiceProcessor.findAll(locale, "BACKOFFICE"));
    }
    ...
    public ResponseEntity<DistrictResponse> findByMultipleFilters(@Valid @RequestBody DistrictMultipleFiltersRequest districtMultipleFiltersRequest,
                                               @Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                               @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return ResponseEntity.ok(districtServiceProcessor.findByMultipleFilters(districtMultipleFiltersRequest, "BACKOFFICE", locale));
    }
    ...
    public ResponseEntity<byte[]> exportDistricts(@RequestBody DistrictMultipleFiltersRequest filters,
        ...
        try {
            ...
            DistrictResponse response = districtServiceProcessor.findByMultipleFilters(filters, "BACKOFFICE", locale);
