...
@RestController
@RequestMapping("/ldms-locations/v1/backoffice/geo-coordinates")
@Tag(name = "Geo Coordinates Backoffice Resource", description = "Operations related to managing geo coordinates (backoffice)")
@RequiredArgsConstructor
public class GeoCoordinatesBackofficeResource {

    private final GeoCoordinatesServiceProcessor geoCoordinatesServiceProcessor;
    private static final Logger logger = LoggerFactory.getLogger(GeoCoordinatesBackofficeResource.class);
    ...
    public GeoCoordinatesResponse create(@Valid @RequestBody final CreateGeoCoordinatesRequest createGeoCoordinatesRequest,
        ...
        return geoCoordinatesServiceProcessor.create(createGeoCoordinatesRequest, locale, "BACKOFFICE");
    }
    ...
    public GeoCoordinatesResponse update(@Valid @RequestBody final EditGeoCoordinatesRequest editGeoCoordinatesRequest,
                                 @Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                 @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return geoCoordinatesServiceProcessor.update(editGeoCoordinatesRequest, locale, "BACKOFFICE");
    }
    ...
    public GeoCoordinatesResponse findById(@PathVariable("id") final Long id,
                                   @Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                   @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return geoCoordinatesServiceProcessor.findById(id, locale, "BACKOFFICE");
    }
    ...
    public GeoCoordinatesResponse delete(@PathVariable("id") final Long id,
                                 @Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                 @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return geoCoordinatesServiceProcessor.delete(id, locale, "BACKOFFICE");
    }
    ...
    public GeoCoordinatesResponse findAllAsAList(@Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                         @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return geoCoordinatesServiceProcessor.findAll(locale, "BACKOFFICE");
    }
    ...
    public GeoCoordinatesResponse findByMultipleFilters(@Valid @RequestBody GeoCoordinatesMultipleFiltersRequest geoCoordinatesMultipleFiltersRequest,
                                               @Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                               @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return geoCoordinatesServiceProcessor.findByMultipleFilters(geoCoordinatesMultipleFiltersRequest, "BACKOFFICE", locale);
    }
    ...
    public ResponseEntity<byte[]> exportGeoCoordinates(@RequestBody GeoCoordinatesMultipleFiltersRequest filters,
        ...
        try {
            ...
            GeoCoordinatesResponse response = geoCoordinatesServiceProcessor.findByMultipleFilters(filters, "BACKOFFICE", locale);
