...
@RestController
@RequestMapping("/ldms-locations/v1/backoffice/localized-name")
@Tag(name = "Localized Name Backoffice Resource", description = "Operations related to managing localized names (backoffice)")
@RequiredArgsConstructor
public class LocalizedNameBackofficeResource {

    private final LocalizedNameServiceProcessor localizedNameServiceProcessor;
    private static final Logger logger = LoggerFactory.getLogger(LocalizedNameBackofficeResource.class);
    ...
    public LocalizedNameResponse create(@Valid @RequestBody final CreateLocalizedNameRequest createLocalizedNameRequest,
        ...
        return localizedNameServiceProcessor.create(createLocalizedNameRequest, locale, "BACKOFFICE");
    }
    ...
    public LocalizedNameResponse update(@Valid @RequestBody final EditLocalizedNameRequest editLocalizedNameRequest,
                                 @Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                 @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return localizedNameServiceProcessor.update(editLocalizedNameRequest, locale, "BACKOFFICE");
    }
    ...
    public LocalizedNameResponse findById(@PathVariable("id") final Long id,
                                   @Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                   @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return localizedNameServiceProcessor.findById(id, locale, "BACKOFFICE");
    }
    ...
    public LocalizedNameResponse delete(@PathVariable("id") final Long id,
                                 @Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                 @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return localizedNameServiceProcessor.delete(id, locale, "BACKOFFICE");
    }
    ...
    public LocalizedNameResponse findAllAsAList(@Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                         @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return localizedNameServiceProcessor.findAll(locale, "BACKOFFICE");
    }
    ...
    public LocalizedNameResponse findByMultipleFilters(@Valid @RequestBody LocalizedNameMultipleFiltersRequest localizedNameMultipleFiltersRequest,
                                               @Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                               @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return localizedNameServiceProcessor.findByMultipleFilters(localizedNameMultipleFiltersRequest, "BACKOFFICE", locale);
    }
    ...
    public ResponseEntity<byte[]> exportLocalizedNames(@RequestBody LocalizedNameMultipleFiltersRequest filters,
        ...
        try {
            ...
            LocalizedNameResponse response = localizedNameServiceProcessor.findByMultipleFilters(filters, "BACKOFFICE", locale);
