...
public class AdministrativeLevelSystemResource {
    ...
    private static final Logger logger = LoggerFactory.getLogger(AdministrativeLevelSystemResource.class);
    ...
    public ResponseEntity<AdministrativeLevelResponse> create(@Valid @RequestBody final CreateAdministrativeLevelRequest createAdministrativeLevelRequest,
        ...
        return ResponseEntity.ok(administrativeLevelServiceProcessor.create(createAdministrativeLevelRequest, locale, "SYSTEM"));
    }
    ...
    public ResponseEntity<AdministrativeLevelResponse> update(@Valid @RequestBody final EditAdministrativeLevelRequest editAdministrativeLevelRequest,
                                 ...
                                 final Locale locale) {
        return ResponseEntity.ok(administrativeLevelServiceProcessor.update(editAdministrativeLevelRequest, locale, "SYSTEM"));
    }
    ...
    public ResponseEntity<AdministrativeLevelResponse> findById(@PathVariable("id") final Long id,
                                   @Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                   @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return ResponseEntity.ok(administrativeLevelServiceProcessor.findById(id, locale, "SYSTEM"));
    }
    ...
    public ResponseEntity<AdministrativeLevelResponse> delete(@PathVariable("id") final Long id,
                                 @Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                 @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return ResponseEntity.ok(administrativeLevelServiceProcessor.delete(id, locale, "SYSTEM"));
    }
    ...
    public ResponseEntity<AdministrativeLevelResponse> findAllAsAList(@Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                         @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return ResponseEntity.ok(administrativeLevelServiceProcessor.findAll(locale, "SYSTEM"));
    }
    ...
    public ResponseEntity<AdministrativeLevelResponse> findByMultipleFilters(@Valid @RequestBody AdministrativeLevelMultipleFiltersRequest administrativeLevelMultipleFiltersRequest,
                                               @Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                               @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return ResponseEntity.ok(administrativeLevelServiceProcessor.findByMultipleFilters(administrativeLevelMultipleFiltersRequest, "SYSTEM", locale));
    }
    ...
    public ResponseEntity<byte[]> exportAdministrativeLevels(@RequestBody AdministrativeLevelMultipleFiltersRequest filters,
        ...
        try {
            ...
            AdministrativeLevelResponse response = administrativeLevelServiceProcessor.findByMultipleFilters(filters, "SYSTEM", locale);
