package projectlx.co.zw.notifications.service.rest.backoffice;
...
public class NotificationTemplateBackofficeResource {
    ...
    public TemplateResponse getAddTemplateMetadata(
        ...
        return notificationTemplateProcessor.getAddTemplateMetadata(locale, "BACKOFFICE");
    }
    ...
    public TemplateResponse create(@Valid @RequestBody final CreateTemplateRequest createTemplateRequest,
                                @Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return notificationTemplateProcessor.create(createTemplateRequest, locale, "BACKOFFICE");
    }
    ...
    public TemplateResponse update(@Valid @RequestBody final UpdateTemplateRequest updateTemplateRequest,
                                 @Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                 @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return notificationTemplateProcessor.update(updateTemplateRequest, "BACKOFFICE", locale);
    }
    ...
    public TemplateResponse findById(@PathVariable("id") final Long id,
                                   @Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                   @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return notificationTemplateProcessor.findById(id, locale, "BACKOFFICE");
    }
    ...
    public TemplateResponse delete(@PathVariable("id") final Long id,
                                 @Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                 @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return notificationTemplateProcessor.delete(id, locale, "BACKOFFICE");
    }
    ...
    public TemplateResponse findAllAsAList(@Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                         @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return notificationTemplateProcessor.findAllAsList(locale, "BACKOFFICE");
    }
    ...
    public TemplateResponse findByMultipleFilters(@Valid @RequestBody final TemplateMultipleFiltersRequest templateMultipleFiltersRequest,
                                                @Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                                @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        return notificationTemplateProcessor.findByMultipleFilters(templateMultipleFiltersRequest, "BACKOFFICE", locale);
    }
    ...
    public ResponseEntity<byte[]> exportTemplates(@Valid @RequestBody final TemplateMultipleFiltersRequest filters,
        ...
        try {
            ...
            switch (format.toLowerCase()) {
                case "csv":
                    data = notificationTemplateProcessor.exportToCsv(filters, "BACKOFFICE", locale);
                    headers.setContentDispositionFormData("attachment", filename + ".csv");
                    break;
                case "excel":
                    data = notificationTemplateProcessor.exportToExcel(filters, "BACKOFFICE", locale);
                    headers.setContentDispositionFormData("attachment", filename + ".xlsx");
                    break;
                case "pdf":
                    data = notificationTemplateProcessor.exportToPdf(filters, "BACKOFFICE", locale);
