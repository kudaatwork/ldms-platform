...
public class NotificationLogBackofficeResource {
    ...
    public NotificationLogResponse findByMultipleFilters(
        ...
        return notificationLogProcessor.findByMultipleFilters(request, BACKOFFICE, locale);
    }
    ...
    public ResponseEntity<byte[]> export(
        ...
        try {
            ...
            if (LdmsExportMediaTypes.isExcel(normalized)) {
                body = notificationLogProcessor.exportToExcel(request, BACKOFFICE, locale);
                ...
                body = notificationLogProcessor.exportToPdf(request, BACKOFFICE, locale);
                ...
                body = notificationLogProcessor.exportToCsv(request, BACKOFFICE, locale);
            ...
            logger.info("Exported notification log as {} ({} bytes) for {}", normalized, body.length, BACKOFFICE);
