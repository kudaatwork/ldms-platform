package projectlx.co.zw.notificationsmanagementservice.service.rest.frontend;
...
import projectlx.co.zw.notificationsmanagementservice.utils.security.NotificationTemplateRoles;
...
@CrossOrigin
@RestController
@RequestMapping("/api/v1/frontend/notification-template")
...
public class NotificationTemplateFrontendResource {
    ...
    public TemplateResponse getAddTemplateMetadata(
        ...
        return notificationTemplateProcessor.getAddTemplateMetadata(locale, username);
    }
    ...
    public TemplateResponse create(@Valid @RequestBody final CreateTemplateRequest createTemplateRequest,
                                ...
                                @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        String username = SecurityContextHolder.getContext().getAuthentication().getName();
        return notificationTemplateProcessor.create(createTemplateRequest, locale, username);
    }
    ...
    public TemplateResponse update(@Valid @RequestBody final UpdateTemplateRequest updateTemplateRequest,
                                 ...
                                 @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        String username = SecurityContextHolder.getContext().getAuthentication().getName();
        return notificationTemplateProcessor.update(updateTemplateRequest, username, locale);
    }
    ...
    public TemplateResponse findById(@PathVariable("id") final Long id,
                                   ...
                                   @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        String username = SecurityContextHolder.getContext().getAuthentication().getName();
        return notificationTemplateProcessor.findById(id, locale, username);
    }
    ...
    public TemplateResponse delete(@PathVariable("id") final Long id,
                                 ...
                                 @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        String username = SecurityContextHolder.getContext().getAuthentication().getName();
        return notificationTemplateProcessor.delete(id, locale, username);
    }
    ...
    public TemplateResponse findAllAsAList(@Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                         @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        String username = SecurityContextHolder.getContext().getAuthentication().getName();
        return notificationTemplateProcessor.findAllAsList(locale, username);
    }
    ...
    public TemplateResponse findByMultipleFilters(@Valid @RequestBody final TemplateMultipleFiltersRequest templateMultipleFiltersRequest,
                                                ...
                                                @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        String username = SecurityContextHolder.getContext().getAuthentication().getName();
        return notificationTemplateProcessor.findByMultipleFilters(templateMultipleFiltersRequest, username, locale);
    }
    ...
    public ResponseEntity<byte[]> exportTemplates(@Valid @RequestBody final TemplateMultipleFiltersRequest filters,
        ...
        try {
            ...
            switch (format.toLowerCase()) {
                case "csv":
                    data = notificationTemplateProcessor.exportToCsv(filters, username, locale);
