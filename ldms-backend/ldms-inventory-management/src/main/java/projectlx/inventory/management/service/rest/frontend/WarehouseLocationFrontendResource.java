...
@CrossOrigin
@RestController
@RequestMapping("/ldms-inventory-management/v1/frontend/warehouse-locations")
@Tag(name = "Warehouse Location Frontend Resource", description = "Operations related to managing warehouse locations (frontend)")
@RequiredArgsConstructor
public class WarehouseLocationFrontendResource {

    private final WarehouseLocationServiceProcessor warehouseLocationServiceProcessor;
    private static final Logger logger = LoggerFactory.getLogger(WarehouseLocationFrontendResource.class);
    ...
    public ResponseEntity<WarehouseLocationResponse> create(@Valid @RequestBody final CreateWarehouseLocationRequest request,
                                                            ...
                                                            final Locale locale) {
        return ResponseEntity.ok(warehouseLocationServiceProcessor.create(request, locale, currentUsername()));
    }
    ...
    public ResponseEntity<WarehouseLocationResponse> findById(@PathVariable("id") final Long id,
                                                              ...
                                                              @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE)
                                                              final Locale locale) {
        return ResponseEntity.ok(warehouseLocationServiceProcessor.findById(id, locale, currentUsername()));
    }
    ...
    public ResponseEntity<WarehouseLocationResponse> listAll(@Parameter(description = Constants.LOCALE_LANGUAGE_NARRATIVE)
                                                             @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE)
                                                             final Locale locale) {
        return ResponseEntity.ok(warehouseLocationServiceProcessor.findAllAsList(locale, currentUsername()));
    }
    ...
    public ResponseEntity<WarehouseLocationResponse> search(@Valid @RequestBody final WarehouseLocationMultipleFiltersRequest request,
                                                            ...
                                                            @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE)
                                                            final Locale locale) {
        return ResponseEntity.ok(warehouseLocationServiceProcessor.findByMultipleFilters(request, currentUsername(), locale));
    }
    ...
    public ResponseEntity<WarehouseLocationResponse> update(@PathVariable("id") final Long id,
        ...
        return ResponseEntity.ok(warehouseLocationServiceProcessor.update(request, currentUsername(), locale));
    }
