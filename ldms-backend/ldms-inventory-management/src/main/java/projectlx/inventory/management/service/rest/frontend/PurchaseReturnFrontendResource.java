...
@CrossOrigin
@RestController
@RequestMapping("/ldms-inventory-management/v1/frontend/purchase-return")
@Tag(name = "Purchase Return Frontend Resource", description = "Operations related to managing purchase returns")
@RequiredArgsConstructor
public class PurchaseReturnFrontendResource {

    private final PurchaseReturnServiceProcessor purchaseReturnServiceProcessor;
    private static final Logger logger = LoggerFactory.getLogger(PurchaseReturnFrontendResource.class);
    ...
    public PurchaseReturnResponse create(@Valid @RequestBody final CreatePurchaseReturnRequest request,
        ...
        return purchaseReturnServiceProcessor.create(request, locale, username);
    }
    ...
    public PurchaseReturnResponse update(@Valid @RequestBody final EditPurchaseReturnRequest request,
                                         ...
                                         final Locale locale) {
        String username = SecurityContextHolder.getContext().getAuthentication().getName();
        return purchaseReturnServiceProcessor.update(request, username, locale);
    }
    ...
    public PurchaseReturnResponse findById(@PathVariable("id") final Long id,
                                           ...
                                           @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        String username = SecurityContextHolder.getContext().getAuthentication().getName();
        return purchaseReturnServiceProcessor.findById(id, locale, username);
    }
    ...
    public PurchaseReturnResponse delete(@PathVariable("id") final Long id,
                                         ...
                                         @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        String username = SecurityContextHolder.getContext().getAuthentication().getName();
        return purchaseReturnServiceProcessor.delete(id, locale, username);
    }
    ...
    public PurchaseReturnResponse findAllAsAList(
            ...
            @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        String username = SecurityContextHolder.getContext().getAuthentication().getName();
        return purchaseReturnServiceProcessor.findAllAsList(locale, username);
    }
    ...
    public PurchaseReturnResponse findByMultipleFilters(
            ...
            @RequestHeader(value = Constants.LOCALE_LANGUAGE, defaultValue = Constants.DEFAULT_LOCALE) final Locale locale) {
        String username = SecurityContextHolder.getContext().getAuthentication().getName();
        return purchaseReturnServiceProcessor.findByMultipleFilters(filters, username, locale);
    }
}